 ...
 * 1⃣️ 对于一个带删除的数字（此处是4），就需要和他的右邻居比较（2），如果这个数>右邻居，则可以删除，
 * 因为如果保留4，则得到的42或45均>25
 * 2⃣️ 对于一种极端情况，如果数字的每一位是递增的：12345678，则从左到右开始，每一位都比右邻居小，此时只需要从右往左删除即可
 */
public class Ex402 {
    ...
    public String removeKdigits(String num, int k) {
        ...
        for (Character digit : num.toCharArray()) {
            // stack的最后一位元素是待删除元素，digit是他的右邻居(最多删除k个)
